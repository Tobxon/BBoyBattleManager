...
QFont b3m::gui::ey2023::SlidesStyle::getBackgroundFont() const
{
	...
	int idFreshmaker = QFontDatabase::addApplicationFont("E:/Dev/Repos/B3M_dev/EY2023/resources/freshmarker.ttf");
...
{
	//TODO if font file not found return common style font
	int idBerlinSans = QFontDatabase::addApplicationFont("E:/Dev/Repos/B3M_dev/EY2023/resources/BRLNSB.ttf");
